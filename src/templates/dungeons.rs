...
pub const BUILTIN_TEMPLATES: &[BuiltinTemplate] = &[
    BuiltinTemplate {
        ...
        message_description: "React to join the O3! Rune carriers, click your rune to confirm.",
        requires_vc: true,
    ...
    BuiltinTemplate {
        ...
        message_description: "React to join the Void! Key holders, click the vial to confirm.",
        requires_vc: true,
    ...
    BuiltinTemplate {
        ...
        message_description: "React to join the Shatters! Key holders, click the crown to confirm.",
        requires_vc: true,
    ...
    BuiltinTemplate {
        ...
        message_description: "React to join Lost Halls! Key holders, click the key to confirm.",
        requires_vc: true,
    ...
    BuiltinTemplate {
        ...
        message_description: "React to join Cult! Key holders, click the key to confirm.",
        requires_vc: true,
    ...
    BuiltinTemplate {
        ...
        message_description: "React to join the Nest! Key holders, click the key to confirm.",
        requires_vc: false,
    ...
    BuiltinTemplate {
        ...
        message_description: "React to join Fungal Cavern! Key holders, click the key to confirm.",
        requires_vc: false,
    ...
    BuiltinTemplate {
        ...
        message_description: "React to join Crystal Cavern! Key holders, click the key to confirm.",
        requires_vc: false,
